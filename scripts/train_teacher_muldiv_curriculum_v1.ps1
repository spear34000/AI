param(
    [string]$ResumeFrom = "artifacts_exact_arith_curriculum_v3_runA/slm_best.pt",
    [string]$OutputDir = "artifacts_teacher_muldiv_curriculum_v1_runA"
)
...
& $py scripts/build_teacher_muldiv_curriculum_v1.py
if ($LASTEXITCODE -ne 0) {
    throw "dataset build failed"
}

& $py -u scripts/train_slm.py `
    --data_path data/teacher_muldiv_curriculum_v1_train.jsonl `
