param(
    ...
    [string]$DataPath = "data/teacher_exact_short_latex_mix_v1_train.jsonl",
    [string]$OutputDir = "artifacts_teacher_exact_short_latex_v1_runA",
    [int]$AdditionalSteps = 1200,
    [double]$Lr = 1.0e-5,
    [int]$EvalInterval = 100,
    [int]$SaveInterval = 200,
    [int]$SeqLen = 384,
    [int]$LoraR = 24,
    [double]$LoraAlpha = 48.0,
