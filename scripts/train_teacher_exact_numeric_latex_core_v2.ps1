param(
    ...
    [string]$OutputDir = "artifacts_exact_numeric_latex_core_v2_runA"
)
...
& $py scripts/build_teacher_exact_numeric_latex_core_v2.py
if ($LASTEXITCODE -ne 0) {
    throw "dataset build failed"
}

& $py -u scripts/train_slm.py `
    --data_path data/teacher_exact_numeric_latex_core_v2_train.jsonl `
