param(
    ...
    [string]$DataPath = "data/answer_only_warmup_v1_train.jsonl",
    [string]$OutputDir = "artifacts_answer_only_warmup_v1_runA",
    [int]$AdditionalSteps = 600,
    [double]$Lr = 3.0e-6,
    [int]$EvalInterval = 60,
    [int]$SaveInterval = 120
)
