param(
    ...
    [string]$OutputDir = "artifacts_teacher_symbolic_arith_mastery_v1_runA"
)
...
& $py scripts/build_teacher_symbolic_arith_mastery_v1.py
if ($LASTEXITCODE -ne 0) {
    throw "dataset build failed"
}

& $py -u scripts/train_slm.py `
    --data_path data/teacher_symbolic_arith_mastery_v1_train.jsonl `
