param(
    ...
    [string]$OutputDir = "artifacts_teacher_tutorlite_arith_v2_runA"
)
...
& $py scripts/build_teacher_tutorlite_arith_v2.py
if ($LASTEXITCODE -ne 0) {
    throw "dataset build failed"
}

& $py -u scripts/train_slm.py `
    --data_path data/teacher_tutorlite_arith_v2_train.jsonl `
