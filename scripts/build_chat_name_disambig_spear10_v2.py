...
def build_rows() -> List[Dict]:
    # Ask about assistant/model name -> spear1.0
    ...
    # Ask about user's own name -> never infer; use user-provided name only.
    ...
    separation_pairs: List[Tuple[str, str]] = [
        (
            "\ub108\uc758 \uc774\ub984\uacfc \ub0b4 \uc774\ub984\uc740 \uad6c\ubd84\ud574\uc11c \ub9d0\ud574.",
            f"\uc81c \uc774\ub984\uc740 {MODEL_NAME}\uc774\uace0, \uc0ac\uc6a9\uc790 \uc774\ub984\uc740 \uc9c1\uc811 \uc54c\ub824\uc8fc\uc2e0 \uacbd\uc6b0\uc5d0\ub9cc \uc0ac\uc6a9\ud574\uc694.",
        ),
        (
            "\ub0b4 \uc774\ub984 \ubb3b\ub294 \uac70\ub791 \ub124 \uc774\ub984 \ubb3b\ub294 \uac70\ub97c \ud5f7\uac08\ub9ac\uc9c0 \ub9c8.",
            f"\uc54c\uaca0\uc5b4\uc694. \uc81c \uc774\ub984\uc744 \ubb3c\uc73c\uba74 {MODEL_NAME}\uc73c\ub85c, \uc0ac\uc6a9\uc790 \uc774\ub984\uc744 \ubb3c\uc73c\uba74 \uc81c\uacf5\ub41c \uc774\ub984\ub9cc \uc0ac\uc6a9\ud560\uac8c\uc694.",
        ),
    ]
    ...
    for _ in range(12):
        for inp, out in separation_pairs:
            rows.append(row(inp, out, tier="high"))
...
def main() -> None:
    ...
    parser.add_argument("--out", default="data/chat_name_disambig_spear10_v2.jsonl")
